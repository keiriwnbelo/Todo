...
// const { users, addAccount, addTodo, removeTodo } = useStore();
...
// const handleAddTodo = (users, title) => {
//     const todo = { id: users, title: newTitle, description: newDescription};
//     addTodo(users, todo);

//     let updatedTodoArr = [...allTodos];
//     updatedTodoArr.push (todo);
//     setTodos (updatedTodoArr);
//     localStorage.setItem ('todolist', JSON.stringify (updatedTodoArr));
